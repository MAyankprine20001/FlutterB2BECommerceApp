    ...
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData && snapshot.data != null) {
          ...
          // Check if the userData is not null and contains the key
          if (userData != null &&
              userData.containsKey(UserDatabaseHelper.PHONE_KEY)) {
            currentPhone = userData[UserDatabaseHelper.PHONE_KEY];
          } else {
            currentPhone = ''; // or handle the case when the key is not present
          }
        }
